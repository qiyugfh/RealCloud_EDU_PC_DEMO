...
public:
	...
	void AddMessageCallBack(TIMMessageCallBack *cb);
	void RemoveMessageCallBack(TIMMessageCallBack *cb);
	std::vector<TIMMessageCallBack *> getMessageCallBacks();
...
private:
	...
	std::vector<TIMMessageCallBack *> msg_cbs_;
